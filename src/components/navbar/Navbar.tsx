...
const Navbar = () => {
  ...
  return (
    ...
    <div className="sticky lg:hidden">
      ...
      >
        <svg
          className={`fill-current h-3 w-3 ${isOpen ? "hidden" : "sticky"}`}
          viewBox="0 0 20 20"
        ...
        <svg
          className={`fill-current h-3 w-3 ${isOpen ? "sticky" : "hidden"}`}
          viewBox="0 0 20 20"
          xmlns="http://www.w3.org/2000/svg"
        >
    ...
    <div
      className={`w-full block flex-grow lg:flex lg:items-center lg:w-auto ${isOpen ? "sticky" : "hidden"}`}
    >
